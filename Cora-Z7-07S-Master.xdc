...
set_property -dict { PACKAGE_PIN T14   IOSTANDARD LVCMOS33 PULLUP TRUE } [get_ports { LCDSDA }]; #IO_L5P_T0_34 Sch=ck_io[2]
set_property -dict { PACKAGE_PIN T15   IOSTANDARD LVCMOS33 PULLUP TRUE } [get_ports { LCDSCL }]; #IO_L5N_T0_34 Sch=ck_io[3]
